...
public final class SystemOS implements Runnable {
  ...
  public void run() {
    ...
    System.out.println("CPU Utilization: " + this.calcCPUUtilization() * 100 + "%");
    System.out.println("Throughput: " + this.calcThroughput() + " procs / cycle");
    System.out.println(
    ...
    compareFiles(
        "C:/Users/Lenovo/Documents/UNIVERSIDAD DEL ROSARIO/V SEMESTRE/Operating"
            + " System/UR_OS/FCFS.txt",
        "C:/Users/Lenovo/Documents/UNIVERSIDAD DEL ROSARIO/V SEMESTRE/Operating System/FCFS.txt");
  }
  ...
  public double calcTurnaroundTime() {
    ...
    for (Process proc : this.processes) {
      times += proc.getTime_finished() - proc.getTime_init();
    }

    return (double) times / this.processes.size();
  }
